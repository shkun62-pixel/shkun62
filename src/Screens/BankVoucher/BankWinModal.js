...
export default function BankWinModal({
  open,
  onClose,
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      bankf3: String(form.bankf3 || "").trim(),
    ...
    try {
      ...
      if (isEdit) {
        res = await axios.put(
          `https://www.shkunweb.com/shkunlive/${tenant}/tenant/bank-win-update/${initialData._id}`,
          payload
        );
      } else {
        res = await axios.post(`https://www.shkunweb.com/shkunlive/${tenant}/tenant/bank-win-post`, payload);
      }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `https://www.shkunweb.com/shkunlive/${tenant}/tenant/bank-win-delete/${initialData._id}`
      );
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText="Example: /bankgst, /bank, /bank-win etc."
                />
              </Grid>
            </Grid>
