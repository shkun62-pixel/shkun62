...
const PurBookPrint = React.forwardRef(({
    ...
    const handleExportExcel = () => {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, 'Pur Book');
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h4 style={{ textAlign:"center",textDecoration:'underline',fontSize:20,color:'darkblue'}}>Purchase Book</h4>
