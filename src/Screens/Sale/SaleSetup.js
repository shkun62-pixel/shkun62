        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={7}>
            <div className="SS-section">
              <div className="SS-expenseHeader">
                <div>EXP</div>
              ...
              {E1name.map((item, index) => (
                <div key={index} className="SS-expenseRow">
                  <TextField
                    id="Exp1"
                    value={formData.Exp1}
                    onChange={handleInputChange}
          ...
          <Grid item xs={12} md={5}>
            <div className="SS-section">
              <Grid container spacing={2}>
                {cgstcode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`cgst-${index}`}>
                    <TextField
                      label="C.GST A/C"
                      fullWidth
                      size="small"
                ...
                {sgstcode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`sgst-${index}`}>
                    <TextField
                      label="S.GST A/C"
                      fullWidth
                      size="small"
                ...
                {igstcode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`igst-${index}`}>
                    <TextField
                      label="I.GST A/C"
                      fullWidth
                      size="small"
                ...
                {cesscode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`cess-${index}`}>
                    <TextField
                      label="CESS CODE"
                      fullWidth
                      size="small"
                ...
                {tdscode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`tds-${index}`}>
                    <TextField
                      label="TDS A/C"
                      fullWidth
                      size="small"
                ...
                {tcscode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`tcs-${index}`}>
                    <TextField
                      label="TCS A/C"
                      fullWidth
                      size="small"
                ...
                {tcs206code.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`tcs206-${index}`}>
                    <TextField
                      label="TCS 206 C(1H)"
                      fullWidth
                      size="small"
                ...
                {discountcode.map((item, index) => (
                  <Grid item xs={12} sm={6} key={`discountcode-${index}`}>
                    <TextField
                      label="DISCOUNT"
                      fullWidth
                      size="small"
                ...
                {cTds.map((item, index) => (
                  <Grid item xs={12} sm={4} key={`cTds-${index}`}>
                    <TextField
                      label="TDS CGST"
                      fullWidth
                      size="small"
                ...
                {sTds.map((item, index) => (
                  <Grid item xs={12} sm={4} key={`sTds-${index}`}>
                    <TextField
                      label="TDS SGST"
                      fullWidth
                      size="small"
                ...
                {iTds.map((item, index) => (
                  <Grid item xs={12} sm={4} key={`iTds-${index}`}>
                    <TextField
                      label="TDS IGST"
                      fullWidth
                      size="small"
    ...
    case 1:
      return (
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <FormControl fullWidth size="small" disabled={!isEditMode || isDisabled}
              sx={{
                "& .MuiOutlinedInput-root": {
                  backgroundColor: "white",
                  borderRadius: "5px",
            ...
            >
              <InputLabel id="billcash-label">BILL CASH</InputLabel>
              <Select
                labelId="billcash-label"
                id="btype"
                value={formData.btype}
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              <InputLabel id="alertbackdate-label">ALERT ON BACK DATE</InputLabel>
              <Select
                labelId="alertbackdate-label"
                id="alertbackdate"
                value={formData.alertbackdate}
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={12} sm={6} md={2}>
            ...
            <Select
              ...
              onChange={handleIndRoundoff}
              disabled={!isEditMode || isDisabled}
              sx={{ backgroundColor: "white", ...textFieldStyle }}
              MenuProps={{ disablePortal: true }}
            >
              <MenuItem value=""><em>None</em></MenuItem>
              <MenuItem value="Yes">Yes</MenuItem>
...
return (
  <div className="SS-newModalz">
    <ToastContainer />

    <div
      className="SS-maincontainer SS-freshSetupShell"
      style={{ backgroundColor: isHighlighted ? "#fff8ea" : "#ffffff" }}
    >
      <div className="SS-topStrip">
        <div className="SS-topStripLeft">
          <h1 className="SS-stripTitle">SALE SETUP</h1>
        </div>

        <div className="SS-topStripCenter">
          <Stepper activeStep={activeStep} alternativeLabel sx={{ mb: 0, width: "100%" }}>
            {steps.map((label, index) => (
              <Step key={label}>
                <StepLabel>
                  <span className="SS-freshStepLabel">
                    {index + 1}. {label}
                  </span>
                </StepLabel>
              </Step>
      ...
      <form className="SS-freshForm">
        <div className="SS-freshContentArea">
          {getStepContent(activeStep)}
        </div>

        <div className="SS-floatingFooter">
          <div className="SS-floatingFooterLeft">
            <div className="SS-footerPill">
          ...
          <Stack
            direction="row"
            spacing={1.5}
            className="SS-floatingFooterActions"
          >
            <Button
              disabled={activeStep === 0}
              onClick={() => setActiveStep((prev) => prev - 1)}
              variant="contained"
              className="SS-freshBtn SS-freshBtnBack"
              type="button"
            >
              BACK
            </Button>
            ...
            <Button
              onClick={() => setActiveStep((prev) => prev + 1)}
              variant="contained"
              className="SS-freshBtn SS-freshBtnNext"
              type="button"
              disabled={activeStep === steps.length - 1}
            >
              NEXT
            ...
            <Button
              ...
              onClick={handleSaveClick}
              variant="contained"
              className="SS-freshBtn SS-freshBtnSave"
              type="button"
            >
              SAVE
            </Button>
            ...
            <Button
              onClick={onClose}
              variant="contained"
              className="SS-freshBtn SS-freshBtnClose"
              type="button"
            >
              CLOSE
            </Button>
            ...
            <Button
              variant="contained"
              className="SS-freshBtn SS-freshBtnSeries"
              onClick={handleOpen}
              type="button"
            >
              SALE SERIES
        ...
        <SaleWinModal open={openSaleWin} onClose={handleClose} />
      </form>
    </div>
  </div>
);
