...
// import PrintVoucherModal from "../CashVoucher/PrintVoucherModal";
// import FAVoucherPDFSale from "./FAVoucherPreSale";
...
//   useEffect(() => {
//     const handleEsc = (e) => {
//       if (e.key === "Escape" && saleId && !isEditMode) {
...
//   }, [navigate, saleId, location.state]);

//   // useEffect(() => {
//   //   const handleEsc = (e) => {
//   //     if (e.key === "Escape" && !isEditMode && saleId ) {
//   //       navigate(-1, { state: { rowIndex: location.state?.rowIndex || 0 } });
//   //     }
//   //   };
...
//           if (type === "normal") {
//             openPrintMenu(); // your existing function
//           } else if (type === "fa") {
//             try {
//               const res = await axios.get(
//                 `https://www.shkunweb.com/shkunlive/shkun_05062025_05062026/tenant/salefafile/byVoucher?vtype=S&voucherno=${formData.vbillno}&rebuild=1&save=1`
//               );
...
//             <Modal.Title>Sale Voucher Preview</Modal.Title>
//           </Modal.Header>
//           <Modal.Body style={{ height: "80vh" }}>
//             {faVoucherData ? (
//               <PDFViewer style={{ width: "100%", height: "100%" }}>
//                 <FAVoucherPDFSale data={faVoucherData} />
//               </PDFViewer>
//             ) : (
//               <div>Loading...</div>
//             )}
