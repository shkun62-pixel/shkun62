...
import OutStandingOptions from "./OutStandingOptions";
import "../TrailBalance/TrailBalance.css";
import PrintTrail from "../TrailBalance/PrintTrail";
...
const fetchLedgerTransactions = (ledger) => {
  ...
  const exportToExcel = () => {
    ...
    const periodTo = ledgerToDate ? ledgerToDate : "--";
    ...
    const sheetData = [
      ...
      [`Debtors List - Period From: ${periodFrom} To: ${periodTo}`],
      [],
      header,
      ...
      <Card className="contMain">
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", marginBottom: "10px" }}>
          ...
          <div style={{ display: "flex", flexDirection:"column", alignItems: "center",gap:"10px" }}>
           ...
           <h3 className="headerTrail">DEBTORS OUTSTANDING</h3>
        ...
        <div style={{display:'flex',flexDirection:"row",alignItems:'center',marginTop:"auto"}}>
          ...
          <PrintOutStanding
            ...
            choice = {"Debtors List"}  // ✅ pass choice
