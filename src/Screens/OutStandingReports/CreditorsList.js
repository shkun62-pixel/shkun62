...
const fetchLedgerTransactions = (ledger) => {
  ...
  const exportToExcel = () => {
    ...
    const sheetData = [
      ...
      [`Creditors List - Period From: ${periodFrom} To: ${periodTo}`],
      [],
      header,
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Creditors List");

    const buffer = XLSX.write(workbook, { bookType: "xlsx", type: "array", cellStyles: true });
    const blob = new Blob([buffer], { type: "application/octet-stream" });
    saveAs(blob, "CrList.xlsx");
  };
      ...
      <Card className="contMain">
        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", marginBottom: "10px" }}>
          ...
          <div style={{ display: "flex", flexDirection:"column", alignItems: "center",gap:"10px" }}>
           ...
           <h3 className="headerTrail">CREDITORS OUTSTANDING</h3>
