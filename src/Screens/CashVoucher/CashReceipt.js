...
import "../BankVoucher/BankVoucher.css";
...
//   }, []);
  ...
  return (
    <div>
      <ToastContainer />
      <h1 className="HeaderBANK">CASH RECEIPT</h1>
      ...
      <div className="topdetails">
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          popperClassName="custom-datepicker-popper"
            ref={datePickerRef}
            className="custom-datepickerBank"
            id="date"
        ...
        <Table ref={tableRef} className="custom-table">
          ...
          >
            <tr style={{ color: "white" }}>
              <th style={{ width: 400 }}>ACCOUNT NAME</th>
              <th style={{ width: 300 }}>CITY NAME</th>
              <th style={{ width: 300 }}>NARRATION</th>
              <th>RECEIPT_NO</th>
              <th>PAYMENT</th>
              <th>RECEIPT</th>
              <th>DISCOUNT</th>
      ...
      <div className="Belowcontent">
        <div
          style={{ display: "flex", flexDirection: "row", justifyContent:'end',marginRight:"10px" }}
        >
          <TextField
            className="custom-bordered-input"
