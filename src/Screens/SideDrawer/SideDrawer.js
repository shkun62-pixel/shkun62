                ...
                <StyledListItem button onClick={() => handleNavigation('/')}>
                    ...
                    <List>
                        ...
                        <List>
                            ...
                            <StyledListItem button onClick={() => handleNavigation('/IncomeTaxReport?type=AccSale')}>
                                <StyledIcon>
                                     <DescriptionIcon />
                                </StyledIcon>
                                <StyledListItemText primary="A/C Wise Summary" />
                            ...
                            <StyledListItem button onClick={() => handleNavigation('/IncomeTaxReport?type=PSale')}>
                             ...
                             <StyledListItem button onClick={() => handleNavigation('/IncomeTaxReport?type=PDetailSale')}>
                                <StyledIcon>
                                    <DescriptionIcon />
                                </StyledIcon>
                                <StyledListItemText primary="Product Wise Detail" />
