...
import GstRateModal from "../Inventory/GstRateModal";
...
const StyledDrawer = styled(Drawer)({
  ".MuiPaper-root": {
    ...
    boxShadow:
      "0px 4px 20px rgba(0, 0, 0, 0.2), 0px 7px 30px rgba(0, 0, 0, 0.1)",
    borderRadius: "10px",
    marginLeft: "5px",
    marginTop: "5px",
    marginBottom: "20px",
...
const StyledListItem = styled(ListItem)({
  ...
  // padding: '15px 20px',
  transition:
    "background-color 0.3s ease-in-out, padding 0.3s ease-in-out, color 0.3s ease-in-out",
});
...
export default function App() {
  ...
  const openGstRateModal = () => setOpen(true);
//   const closeGstRateModal = () => setOpen(false);
  const closeGstRateModal = () => {
            ...
            {isSaleOpen && (
              ...
              >
                <List>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/JournalVoucher")}
                  >
                    <StyledIcon>
                      <ReceiptIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/LedgerAcc")}
                  >
                    <StyledIcon>
                      <AccountTreeIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/NewStockAcc")}
                  >
                    <StyledIcon>
                      <InventoryIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/Productioncard")}
                  >
                    <StyledIcon>
                      <BarChartIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onMouseEnter={() => setIsInvOpen(true)}
                    onMouseLeave={() => setIsInvOpen(false)}
                  >
                    <StyledIcon>
                  ...
                  {isInvOpen && (
                    ...
                    >
                      <List>
                        <StyledListItem button onClick={() => handleNavigation("/Inventory?type=LedgerPost")}>
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                          <StyledListItemText primary="Ledger Post Setup" />
                        </StyledListItem>
                        {/* <GstRateModal open={open} onClose={closeGstRateModal} /> */}
                      </List>
                    </motion.div>
                  )}
                  <StyledListItem
                  ...
                  {isGoodReturn && (
                    ...
                    >
                      <List>
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/SalesReturn")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/PurchasesReturn")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
            ...
            {isReportOpen && (
              ...
              >
                <List>
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/LedgerList")}
                  >
                    <StyledIcon style={{}}>
                      <DescriptionIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/TrailBalance")}
                  >
                    <StyledIcon style={{}}>
                      <BalanceIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/PaymentList")}
                  >
                    <StyledIcon>
                      <MenuBookIcon />
                    </StyledIcon>
                  ...
                  <StyledListItem
                    button
                    onClick={() => handleNavigation("/ReceiptList")}
                  >
                    <StyledIcon>
                      <MenuBookIcon />
                    </StyledIcon>
                  ...
                  {isBooksOpen && (
                    ...
                    >
                      <List>
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/SaleBook")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/PurchaseBook")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/Books?type=cBook")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/Books?type=jBook")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/BankBook")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                  ...
                  {isSummaryOpen && (
                    ...
                    >
                      <List>
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/SaleSumm")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/PurchaseSumm")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                    ...
                    >
                      <List>
                        <StyledListItem
                          button
                          onClick={() =>
                            handleNavigation("/Ledgers?type=LedgerPrint")
                          }
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                        ...
                        <StyledListItem
                          button
                          onClick={() =>
                            handleNavigation("/Ledgers?type=LedgerSummary")
                          }
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                        ...
                        <StyledListItem
                          button
                          onClick={() =>
                            handleNavigation("/Ledgers?type=LedgerMaster")
                          }
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                  ...
                  {isOutStandingOpen && (
                    ...
                    >
                      <List>
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/DebtorsList")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
                        ...
                        <StyledListItem
                          button
                          onClick={() => handleNavigation("/CreditorsList")}
                        >
                          <StyledIcon>
                            <MenuBookIcon />
                          </StyledIcon>
          ...
          {isGstReportOpen && (
            ...
            >
              <List>
                ...
                <StyledListItem
                  button
                  onClick={() => handleNavigation("/GstRegister")}
                >
                  <StyledIcon style={{}}>
                    <DescriptionIcon />
                  </StyledIcon>
                ...
                <StyledListItem
                  button
                  onClick={() => handleNavigation("/GstWorksheet")}
                >
                  <StyledIcon style={{}}>
                    <DescriptionIcon />
                  </StyledIcon>
                ...
                <StyledListItem button onClick={() => handleNavigation("/GstReport?type=AcwiseGstReport")}>
                  <StyledIcon style={{}}>
                    <DescriptionIcon />
                  </StyledIcon>
                ...
                {isTaxWiseOpen && (
                  ...
                  >
                    <List>
                      <StyledListItem
                        button
                        onClick={() => handleNavigation("/TaxWiseSale")}
                      >
                        <StyledIcon>
                          <MenuBookIcon />
                        </StyledIcon>
                      ...
                      <StyledListItem
                        button
                        onClick={() => handleNavigation("/TaxWisePur")}
                      >
                        <StyledIcon>
                          <MenuBookIcon />
                        </StyledIcon>
                ...
                <StyledListItem
                  button
                  onClick={() => handleNavigation("/GstReport?type=HsnWise")}
                >
                  <StyledIcon style={{}}>
                    <DescriptionIcon />
                  </StyledIcon>
                  ...
                  >
                    <List>
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=party")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=account")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=PPur")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=PDetail")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=StatePur")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=BrokerPur")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                  ...
                  >
                    <List>
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=saleParty")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=AccSale")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=PSale")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=PDetailSale")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=StateSale")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
                      ...
                      <StyledListItem
                        button
                        onClick={() =>
                          handleNavigation("/IncomeTaxReport?type=BrokerSale")
                        }
                      >
                        <StyledIcon>
                          <DescriptionIcon />
