  ...
  (
    ...
    const calculateTotalQuantity = () => {
      const total = (items || []).reduce((acc, currentItem) => {
        return acc + Number(currentItem.weight);
      }, 0);
                ...
                return (
                  ...
                  >
                    <div>
                      ...
                      {/* <div style={{height:1,backgroundColor:'black',width:"103.8%",marginLeft:-20}}></div> */}
                      <div
                        style={{
                          textAlign: "center",
                          height: 130,
                      ...
                      >
                        ...
                        >
                          <div style={{}}>
                            <text style={{ marginLeft: "30%", fontSize: 30 }}>
                              TAX-INVOICE
                            </text>
                          </div>
                          <div
           ...
           <div
                    ...
                    >
                      ...
                      <div style={{ width: 450 }}>
                        ...
                        {/* <div style={{borderTop:"1px solid black",marginTop:0,height:34,width:"175%"}}>
                    ...
                    >
                      <text
                        style={{ fontSize: 17, marginTop: 5, color: "red" }}
                      >
