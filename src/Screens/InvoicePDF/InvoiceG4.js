...
const InvoiceG4 = React.forwardRef(({
    formData,
    items,
    customerDetails,
    shipped,
           ...
           {selectedCopies.flatMap((copyType, copyIndex) =>
              chunks.map((chunk, pageIndex) => {
                ...
                return (
                  ...
                  <div>
                    ...
                    >
                      <div style={{display:"flex",flexDirection:"row",border:"1px solid black",height:50,width:"100%",justifyContent:'space-between'}}>
                        <text style={{fontSize:20,marginLeft:10,marginTop:10}}>Invoice No. {formData.vbillno}</text>
                        ...
                        <text style={{fontSize:20,marginTop:10,marginRight:10}}>Invoice Date. {formatDate(formData.date)}</text>
                      </div>
                    </div>
                    <div
                      style={{
              ...
              <div style={{display:"flex",flexDirection:"row",borderLeft:"1px solid black",borderRight:"1px solid black",borderBottom:"1px solid black",height:230}}>
                  ...
                  <div style={{width:450}}>
                    ...
                    <div style={{marginTop:10,height:"82%",display:'flex',flexDirection:'column'}}>
                      <text style={{marginLeft:10,fontSize:18}}>{formData.rem2}</text>
                      <text style={{marginLeft:10,fontSize:18}}>Transporter Name : {formData.v_tpt}</text>
                      <text style={{marginLeft:10,fontSize:18}}>Vehicle No : {formData.trpt}</text>
                      <text style={{marginLeft:10,fontSize:18}}>GR No : {formData.gr}</text>
                    </div>
