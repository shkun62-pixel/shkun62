                ...
                return (
                  ...
                  >
                    <div style={{marginTop:10}}>
                      <span style={{fontSize:30,marginLeft:"42%"}}>TAX-INVOICE</span>
                    </div>
                <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <div style={{width:"50%",height:"100%",borderRight:"1px solid black",display:'flex',flexDirection:'column'}}>
                      ...
                      <div style={{borderBottom:"1px solid black",height:"25%"}}>
                      <text style={{fontSize:20,marginLeft:10}}>Self Invoice Date.{formatDate(formData.date)}</text>
                      </div>
                      <div style={{height:"25%"}}>
                    ...
                    {/* Shipped to */}
                      ...
                      <div style={{borderBottom:"1px solid black",height:"25%"}}>
                          <text style={{fontSize:20,marginLeft:10}}>Doc Date.{formData.date ? new Date(formData.date).toLocaleDateString("en-GB") : ""}</text>
                      </div>
                      <div style={{borderBottom:"1px solid black",height:"25%"}}>
