...
const InvoicePur2 = React.forwardRef(({
    formData,
    items,
    supplierdetails,
              ...
              chunks.map((chunk, pageIndex) => {
                ...
                return (
                  ...
                  >
                    ...
                    <a style={{fontSize:20,marginLeft:10}}>{companyAdd}</a>
                    <div style={{display:'flex',flexDirection:'row',marginLeft:10}}>
                    <a style={{fontSize:20}}>GSTIN: {companyGST}</a>
                    <a style={{fontSize:20,marginLeft:20}}>PAN: {companyPAN}</a>
                    </div>
                    <div style={{display:'flex',flexDirection:'row',marginLeft:10}}>
                    <a style={{fontSize:20}}>Ph No: {companyPhn}</a>
                    <a style={{fontSize:20,marginLeft:20}}>Email: {companyEmail}</a>
                    </div>
                          </div>
                          <div style={{height:"100%",width:"50%",display:'flex',flexDirection:'column',borderBottom:'1px solid',textAlign:'center'}}>
                              <div style={{borderBottom:'1px solid black',height:"33.3%"}}>
                                  <text style={{fontSize:25}}>ORIGINAL FOR RECIEPIENT</text>
                              </div>
                              <div style={{borderBottom:'1px solid black',height:"33.3%"}}>
                              <text style={{fontSize:25}}>DUPLICATE FOR TRANSPORTER</text>
                              </div>
                              <div style={{height:"33.3%"}}>
                              <text style={{fontSize:25}}>OFFICE COPY</text>
                              </div>
                          </div>
                      </div>
                      {/* 2nd */}
                        ...
                        <div key={item.vacode}>
                          ...
                          <div style={{height:"100%",width:"50%",display:'flex',flexDirection:'column'}}>
                              ...
                              <div style={{borderRight:"1px solid black",borderBottom:"1px solid black",width:"50%",height:53,paddingTop:10}}>
                                  <a style={{fontSize:20,marginLeft:10}}>Self Invoice No.</a>
                                  <text style={{fontSize:20,marginLeft:10}}>{formData.vbillno}</text>
                              </div>
                              <div style={{borderBottom:"1px solid black",width:"50%",height:53,paddingTop:10}}>
                                  <a style={{fontSize:20,marginLeft:10}}>Dated:</a>
                                  <text style={{fontSize:20,marginLeft:10}}>{formatDate(formData.date)}</text>
                              </div>
                              </div>
                              <div style={{display:'flex',flexDirection:'row',width:"100%"}}>
                              <div style={{borderRight:"1px solid black",borderBottom:"1px solid black",width:"50%",height:53,paddingTop:10}}>
                                  <a style={{fontSize:20,marginLeft:10}}>GR NO.</a>
                              ...
                              <div style={{width:"50%",height:53,display:'flex',flexDirection:'column',borderBottom:"1px solid black",}}>
                                  <a style={{fontSize:20,marginLeft:10}}>Payement Mode:</a>
                                  <text style={{marginLeft:20}}>CREDIT</text>
                              </div>
                              </div>
                              <div style={{display:'flex',flexDirection:'row',width:"100%"}}>
                              <div style={{borderRight:"1px solid black",width:"50%",height:54,display:'flex',flexDirection:'column'}}>
                                  <a style={{fontSize:20,marginLeft:10}}>Vehicle No.</a>
                                  <text style={{fontSize:20,marginLeft:10,marginTop:-5}}>{formData.trpt}</text>
                              </div>
                              <div style={{width:"50%",height:53,paddingTop:10}}>
                                  <a style={{fontSize:20,marginLeft:10}}>Reverse Charges.</a>
                      ...
                      <div style={{display:'flex',flexDirection:'row'}}>
                      <div style={{borderTop:'1px solid black',borderRight:'1px solid black',height:150,width:"70%",display:'flex',flexDirection:'row'}}>
                      <img src={qrcode} alt="QR Code" style={{ width: '140px', height: '140px' ,marginLeft:5,marginTop:5}} />
                      <div style={{display:'flex',flexDirection:'column'}}>
                        <div style={{display:'flex',flexDirection:'row'}}>
                        <a style={{fontSize:18,marginLeft:5}}>EWB No:</a>
                        <text style={{fontSize:18,marginLeft:2}}>9854834</text>
                        </div>
                        <div style={{display:'flex',flexDirection:'row'}}>
                        <a style={{fontSize:18,marginLeft:5}}>Valid upto:</a>
                        <text style={{fontSize:18,marginLeft:2}}>28/11/2024</text>
                        </div>
                        <div style={{display:'flex',flexDirection:'row'}}>
                        <a style={{fontSize:18,marginLeft:5}}>IRN:</a>
                      ...
                      {/* 3RD RIGHT */}
                      <div style={{borderTop:'1px solid black',height:150,width:"50%"}}>
                      <div style={{borderBottom:'1px solid black',height:"25%"}}>
                      <a style={{fontSize:20,marginLeft:10}}>Doc No:</a>
                      <text style={{fontSize:20,marginLeft:10}}>{formData.vno}</text>
                      </div>
                      <div style={{borderBottom:'1px solid black',height:"25%"}}>
                      <a style={{fontSize:20,marginLeft:10}}>Doc.Date:</a>
                      <text style={{fontSize:20,marginLeft:10}}>  {formData.date ? new Date(formData.date).toLocaleDateString("en-GB") : ""}</text>
                      </div>
                      <div style={{borderBottom:'1px solid black',height:"25%"}}>
                      <a style={{fontSize:20,marginLeft:10}}>Transporter Name:</a>
                      <text style={{fontSize:20,marginLeft:10}}>{formData.v_tpt}</text>
                      </div>
                      {supplierdetails.map((item) => (
                        <div key={item.vacode}>
                          <a style={{marginLeft:10,fontSize:20}}>Destination:</a>
...
<div style={{display:"flex",flexDirection:'row',height:'100%'}}>
  <div style={{width:"40%",borderRight:"1px solid black",padding:10}}>
...
<div style={{display:'flex',flexDirection:'column',width:"30%",height:"100%"}}>
    ...
    <text style={{fontSize:20,color:'red',marginLeft:10}}>Total Tax: {formData.tax}</text>
    </div>
    <div style={{borderBottom:"1px solid black"}}>
    <text style={{fontSize:20,color:'red',marginLeft:10}}>Grand Total:{formData.grandtotal}</text>
    </div>
</div>
</div>
                  {/* EXPENSE */}
