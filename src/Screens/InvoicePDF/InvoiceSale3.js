  ...
  (
    ...
    function numberToIndianWords(num) {
      ...
      while (whole.length > 0) {
        let part = 0;
        if (scaleIndex === 0) {
          // Last 3 digits for Thousand
          part = parseInt(whole.slice(-3));
          whole = whole.slice(0, -3);
        } else {
          // Next 2 digits for Lakh, Crore, etc.
            ...
            {selectedCopies.flatMap((copyType, copyIndex) =>
              chunks.map((chunk, pageIndex) => {
                ...
                const paddedChunk = [
                  ...chunk,
                  ...Array.from(
                    { length: targetSize - chunk.length },
                    (_, fillerIndex) => ({
                      id: "",
                      sdisc: "",
                      tariff: "",
                ...
                return (
                  ...
                  >
                    <div style={{ marginTop: 20 }}>
                      <text style={{ fontSize: 30, marginLeft: "42%" }}>
                        TAX-INVOICE
                      </text>
                      <text style={{ fontSize: 20, marginLeft: "28%" }}>
                        {selectedCopies.length > 0
                          ? copyType.replace(/([A-Z])/g, " $1").toUpperCase()
                          : "OFFICE COPY"}
                      </text>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <text style={{ fontSize: 20, marginLeft: 10 }}>
                              Invoice Date. {formatDate(formData.date)}
                            </text>
                          </div>
                          <div
                            style={{
                          ...
                          <div style={{ height: "25%" }}>
                            <text style={{ fontSize: 20, marginLeft: 10 }}>
                              Transporter Name. {formData.v_tpt}
                            </text>
                          </div>
                        </div>
                        <div
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span style={{fontSize:18, borderBottom:"1px solid black", textAlign:'center',fontWeight:'bold'}}>Other Details</span>
                    ...
                    <div style={{ fontSize: "12px" }}>
                      <text>
                        Footer content specific to page {pageIndex + 1}
                      </text>
                    </div>
                  </div>
                );
