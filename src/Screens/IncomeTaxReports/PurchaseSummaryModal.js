...
export default function PurchaseSummaryModal({ show, onClose }) {
  ...
  return (
    <>
      ...
      {/* <Modal show={show} onHide={onClose} size="lg" centered>
    <Modal.Header closeButton>
        <Modal.Title>Purchase Summary Party Wise</Modal.Title>
    </Modal.Header>
    ...
    <Modal.Body>
        ...
        <Row className="mt-3">
            ...
            <Button
                ...
                onClick={() =>
                alert("Select Ledger Accounts (not implemented)")
                }
            >
            ...
            <Button
                variant="warning"
                onClick={() =>
                alert("Export not implemented – add XLSX export later")
                }
            >
                Export
            </Button>{" "}
