...
export default function BrokerWisePur({ show, onClose }) {
  ...
  const exportToExcel = () => {
    ...
    const title = `Broker Wise Purchase Summary - From: ${fromDate} To: ${toDate}`;
    ...
    XLSX.writeFile(wb, "BrokerWisePur.xlsx");
  };
      ...
      <Modal.Body style={{ maxHeight: "calc(100vh - 120px)", overflowY: "auto" }}>
        {fetching ? (
          ...
          <AccountWisePrint
            ...
            tittle = {"BROKERAGE DETAIL PURCHASE"}
          />
        )}
      </Modal.Body>
