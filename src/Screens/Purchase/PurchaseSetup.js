...
//       const apiEndpoint = `https://www.shkunweb.com/shkunlive/${tenant}/tenant/purchasesetup${
//         isAbcmode ? `/${data1._id}` : ""
//       }`;
...
const textFieldStyle4 = {
  ...
  switch (step) {
    case 0:
      return (
        <div className="ps-stepContent">
          <Grid container spacing={2}>
            {/* LEFT SIDE */}
            <Grid item xs={12} lg={7}>
              <div className="ps-sectionCard">
                <div className="ps-sectionTitle">Expense Accounts</div>

                <div className="ps-expenseHeaderRow">
                  <span style={{ width: 120 }}></span>
                  <span style={{ width: 240 }}>Account</span>
                  <span style={{ width: 70, textAlign: "center" }}>+/-</span>
                  <span style={{ width: 70, textAlign: "center" }}>
                    Calculation
                  </span>
                  <span style={{ width: 90, textAlign: "center" }}>Rate</span>
                </div>

                <div className="ps-expenseRows">
                  {E1name.map((item, index) => (
                    <div key={index} className="ps-expenseRow">
                      <TextField
                        id="Exp1"
                        value={formData.Exp1}
                        onChange={handleInputChange}
            ...
            <Grid item xs={12} lg={5}>
              <div className="ps-sectionCard">
                <div className="ps-sectionTitle">Tax Codes & Compliance</div>

                <div className="ps-twoColHeading">
                  <span>REGD. DEALER</span>
                  <span>UN-REGD. DEALER</span>
                </div>

                <div className="ps-taxRows">
                  {/* CGST */}
                  {/* <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">C.GST A/C</div>
                    <Grid container spacing={2}>
                      {cgstcode.map((item, index) => (
                        <Grid item xs={12} key={`cgstcode-${index}`}>
                          <TextField
                            label="ITC(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "cgstcode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {cgstcode1.map((item, index) => (
                        <Grid item xs={12} md={6} key={`cgstcode1-${index}`}>
                          <TextField
                            label="ITC REVERSE(CR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "cgstcode1")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {cgstcode2.map((item, index) => (
                        <Grid item xs={12} md={6} key={`cgstcode2-${index}`}>
                          <TextField
                            label="ITC REVERSE(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "cgstcode2")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
  ...
  <Grid container spacing={2}>
    {cgstcode.map((item, index) => (
      <Grid item xs={12} md={4} key={`cgstcode-${index}`}>
        <TextField
          label="ITC(DR)"
          fullWidth
          size="small"
    ...
    {cgstcode1.map((item, index) => (
      <Grid item xs={12} md={4} key={`cgstcode1-${index}`}>
        <TextField
          label="ITC REVERSE(CR)"
          fullWidth
          size="small"
    ...
    {cgstcode2.map((item, index) => (
      <Grid item xs={12} md={4} key={`cgstcode2-${index}`}>
        <TextField
          label="ITC REVERSE(DR)"
          fullWidth
          size="small"
    ...
    {showModalcgst2 && (
      ...
      />
                  ...
                  {/* SGST */}
                  {/* <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">S.GST A/C</div>
                    <Grid container spacing={2}>
                      {sgstcode.map((item, index) => (
                        <Grid item xs={12} key={`sgstcode-${index}`}>
                          <TextField
                            label="ITC(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "sgstcode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {sgstcode1.map((item, index) => (
                        <Grid item xs={12} md={6} key={`sgstcode1-${index}`}>
                          <TextField
                            label="ITC REVERSE(CR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "sgstcode1")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {sgstcode2.map((item, index) => (
                        <Grid item xs={12} md={6} key={`sgstcode2-${index}`}>
                          <TextField
                            label="ITC REVERSE(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "sgstcode2")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
  ...
  <Grid container spacing={2}>
    {sgstcode.map((item, index) => (
      <Grid item xs={12} md={4} key={`sgstcode-${index}`}>
        <TextField
          label="ITC(DR)"
          fullWidth
          size="small"
    ...
    {sgstcode1.map((item, index) => (
      <Grid item xs={12} md={4} key={`sgstcode1-${index}`}>
        <TextField
          label="ITC REVERSE(CR)"
          fullWidth
          size="small"
    ...
    {sgstcode2.map((item, index) => (
      <Grid item xs={12} md={4} key={`sgstcode2-${index}`}>
        <TextField
          label="ITC REVERSE(DR)"
          fullWidth
          size="small"
    ...
    {showModalsgst2 && (
      ...
      />
                  ...
                  {/* IGST */}
                  {/* <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">I.GST A/C</div>
                    <Grid container spacing={2}>
                      {igstcode.map((item, index) => (
                        <Grid item xs={12} key={`igstcode-${index}`}>
                          <TextField
                            label="ITC(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "igstcode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {igstcode1.map((item, index) => (
                        <Grid item xs={12} md={6} key={`igstcode1-${index}`}>
                          <TextField
                            label="ITC REVERSE(CR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "igstcode1")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {igstcode2.map((item, index) => (
                        <Grid item xs={12} md={6} key={`igstcode2-${index}`}>
                          <TextField
                            label="ITC REVERSE(DR)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "igstcode2")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
  ...
  <Grid container spacing={2}>
    {igstcode.map((item, index) => (
      <Grid item xs={12} md={4} key={`igstcode-${index}`}>
        <TextField
          label="ITC(DR)"
          fullWidth
          size="small"
    ...
    {igstcode1.map((item, index) => (
      <Grid item xs={12} md={4} key={`igstcode1-${index}`}>
        <TextField
          label="ITC REVERSE(CR)"
          fullWidth
          size="small"
    ...
    {igstcode2.map((item, index) => (
      <Grid item xs={12} md={4} key={`igstcode2-${index}`}>
        <TextField
          label="ITC REVERSE(DR)"
          fullWidth
          size="small"
    ...
    {showModaligst2 && (
      ...
      />
                  ...
                  {/* TDS */}
                  <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">TDS / Additional Tax</div>
                    <Grid container spacing={2}>
                      {cTds.map((item, index) => (
                        <Grid item xs={12} md={4} key={`cTds-${index}`}>
                          <TextField
                            label="TDS CGST"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "cTds_code")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {sTds.map((item, index) => (
                        <Grid item xs={12} md={4} key={`sTds-${index}`}>
                          <TextField
                            label="TDS SGST"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "sTds_code")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {iTds.map((item, index) => (
                        <Grid item xs={12} md={4} key={`iTds-${index}`}>
                          <TextField
                            label="TDS IGST"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "iTds_code")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                  ...
                  {/* Ad / Cess / TCS */}
                  <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">Other Codes</div>
                    <Grid container spacing={2}>
                      {Adcode.map((item, index) => (
                        <Grid item xs={12} md={4} key={`Adcode-${index}`}>
                          <TextField
                            label="PUR.IMP GST"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "Adcode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {cesscode.map((item, index) => (
                        <Grid item xs={12} md={4} key={`cesscode-${index}`}>
                          <TextField
                            label="CESS CODE"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "cesscode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {tcs206code.map((item, index) => (
                        <Grid item xs={12} md={4} key={`tcs206code-${index}`}>
                          <TextField
                            label="TCS 206 C(1H)"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "tcs206code")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                  ...
                  {/* TCS A/C row */}
                  <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">TCS / Discount / Rates</div>
                    <Grid container spacing={2}>
                      {tcscode.map((item, index) => (
                        <Grid item xs={12} md={4} key={`tcscode-${index}`}>
                          <TextField
                            label="TCS A/C"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "tcscode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                      ...
                      {discountcode.map((item, index) => (
                        <Grid item xs={12} md={4} key={`discountcode-${index}`}>
                          <TextField
                            label="DISCOUNT"
                            fullWidth
                            size="small"
                            ...
                            onKeyDown={(e) =>
                              handleOpenModal(e, index, "discountcode")
                            }
                            InputProps={{
                              readOnly: !isEditMode || isDisabled,
                            }}
                  ...
                  <div className="ps-taxRow">
                    <div className="ps-taxRowLabel">TCS On Tax</div>
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                        <Select
                          id="Tcsontax"
    ...
    case 1:
      return (
        <div className="ps-stepContent">
          <div className="ps-sectionCard">
            <div className="ps-sectionTitle">Other Options</div>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={4}>
                <FormLabel className="ps-label">TAXTYPE</FormLabel>
                <Select
                  id="stype"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4}>
                <FormLabel className="ps-label">BILL CASH</FormLabel>
                <Select
                  id="btype"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4}>
                <FormLabel className="ps-label">SUPPLY</FormLabel>
                <Select
                  id="conv"
                  fullWidth
                  size="small"
    ...
    case 2:
      return (
        <div className="ps-stepContent">
          <div className="ps-sectionCard">
            <div className="ps-sectionTitle">Additional Settings</div>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">ROUND OFF</FormLabel>
                <Select
                  id="T11"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">TAX ROUND OFF</FormLabel>
                <Select
                  id="T12"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">DISPLAY ITEM</FormLabel>
                <Select
                  id="T13"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">DEFAULT BUTTON</FormLabel>
                <Select
                  id="T14"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">LOW SALE</FormLabel>
                <Select
                  id="T15"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={6} lg={3}>
                <FormLabel className="ps-label">TDS 194Q POLICY 50 LAC</FormLabel>
                <Select
                  id="T16"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={6} lg={3}>
                <FormLabel className="ps-label">TDS OPTIONS</FormLabel>
                <Select
                  id="T19"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">ZERO VALUE POST</FormLabel>
                <Select
                  id="T20"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={4} lg={2}>
                <FormLabel className="ps-label">DISPLAY HSN CODE</FormLabel>
                <Select
                  id="T18"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={6} lg={3}>
                <FormLabel className="ps-label">INVOICE FORMAT</FormLabel>
                <Select
                  id="reportformat"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} md={6} lg={2}>
                <FormLabel className="ps-label">CD WINDOW</FormLabel>
                <Select
                  id="T10"
                  fullWidth
                  size="small"
...
return (
  <div className="ps-newModalz">
    <ToastContainer />

    <div
      className="ps-maincontainer ps-freshSetupShell"
      style={{ backgroundColor: isHighlighted ? "#fff8ea" : "#ffffff" }}
    >
      <div className="ps-topStrip">
        <div className="ps-topStripLeft">
          <h1 className="ps-stripTitle">PURCHASE SETUP</h1>
        </div>

        <div className="ps-topStripCenter">
          <Stepper activeStep={activeStep} alternativeLabel sx={{ mb: 0, width: "100%" }}>
            {steps.map((label, index) => (
              <Step key={label}>
                <StepLabel>
                  <span className="ps-freshStepLabel">
                    {index + 1}. {label}
                  </span>
                </StepLabel>
              </Step>
      ...
      <form className="ps-form">
        <div className="ps-bodyScroll">
          {getStepContent(activeStep)}
        </div>

        <div className="ps-floatingFooter">
          <div className="ps-floatingFooterLeft">
            <div className="ps-footerPill">
          ...
          <Stack
            direction="row"
            spacing={1.5}
            className="ps-floatingFooterActions"
          >
            <Button
              disabled={activeStep === 0}
              onClick={() => setActiveStep((prev) => prev - 1)}
              variant="contained"
              className="ps-btn ps-btnBack"
              type="button"
            >
              BACK
            </Button>
          ...
          <PurWinModal open={openPurWin} onClose={handleClose} />
        </div>
      </form>
    </div>
  </div>
