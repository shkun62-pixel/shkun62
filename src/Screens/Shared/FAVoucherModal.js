...
// // vtype config (sale vs purchase)
// const configMap = {
//   S: {
//     apiPath: "salefafile",
//     headerTitle: "FA VOUCHER (SALE)",
//     postingLabel: "Sale FA Entries",
//     previewId: "sale-fa-preview",
//   },
//   P: {
//     apiPath: "purchasefaFile",
//     headerTitle: "FA VOUCHER (PURCHASE)",
//     postingLabel: "Purchase FA Entries",
//     previewId: "pur-fa-preview",
//   },
// };
...
//   tenant,
//   voucherno,
//   vtype = "S", // default Sale
//   headerTitle, // allow override
// }) {
...
//   const cfg = configMap[vtype] || configMap["S"]; // fallback to Sale config
//   const effectiveHeader = headerTitle || cfg.headerTitle;
...
//     if (!preview) return;
//     const css = getScopedCss(cfg.previewId); // scoped CSS
//     const html = `
//     <!doctype html>
//     <html>
//     <head>
...
//   // scoped CSS (previewId-specific)
//   const getScopedCss = (id) => `
//     #${id} * { box-sizing:border-box; font-family: system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif; }
//     #${id} .wrap { width:100%; background:#fff; }
//     #${id} .topbar {
...
//       margin-bottom:12px;
//     }
//     #${id} .brand-block { text-align:left; }
//     #${id} .brand { font-size:20px; font-weight:800; letter-spacing:.3px; }
//     #${id} .sub { font-size:12px; color:#475569; }
//     #${id} .badge {
...
//     }
//     #${id} .meta .box strong { color:#111827; }
...
//     }
//     #${id} tbody tr:nth-child(odd) { background:#fafafa; }
//     #${id} .desc { width:60%; }
//     #${id} .num  { text-align:right; width:20%; white-space:nowrap; }
...
//     }
//     #${id} .ok { background:#ecfdf5; color:#065f46; border-color:#a7f3d0; }
//     #${id} .bad { background:#fef2f2; color:#991b1b; border-color:#fecaca; }

//     #${id} .signs { display:flex; justify-content:space-between; margin-top:36px; font-size:12px; color:#6b7280; }
//     #${id} .line { min-width:28%; text-align:center; }
//   `;
...
//         >
//           {/* on-screen CSS */}
//           <style>{getScopedCss(cfg.previewId)}</style>
...
//           {!loading && !error && fa && (
//             <div id={cfg.previewId} className="wrap">
//               {/* Top ribbon */}
