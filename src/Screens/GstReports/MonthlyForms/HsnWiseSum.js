        ...
        <TableBody>
          {rows.map((r, i) => (
            ...
            >
              ...
              <TableCell align="right">{r.gst}</TableCell>
              <TableCell align="right">0</TableCell>
              <TableCell align="right">{r.qty.toFixed(3)}</TableCell>
          ...
          {/* TOTAL */}
          <TableRow sx={{ borderTop: "2px solid #000", background: "#f0f0f0" }}>
            <TableCell colSpan={3}>
              <b>Total</b>
            </TableCell>
            <TableCell align="right">
              <b>{total.qty.toFixed(3)}</b>
            </TableCell>
            <TableCell align="right">
              <b>{total.value.toFixed(2)}</b>
            </TableCell>
            <TableCell align="right">
              <b>{total.cgst.toFixed(2)}</b>
            </TableCell>
            <TableCell align="right">
              <b>{total.sgst.toFixed(2)}</b>
            </TableCell>
            <TableCell align="right">
              <b>{total.igst.toFixed(2)}</b>
            </TableCell>
            <TableCell align="right">0</TableCell>
          </TableRow>
        </TableBody>
